...
public class headphones extends SoundDevices implements SoundDevicesDataInformation {
    ...
    public headphones(String color, String material, int weight, boolean battery, boolean display, int cost, String connexion, String functionallity, String tradeMark, int model) {
